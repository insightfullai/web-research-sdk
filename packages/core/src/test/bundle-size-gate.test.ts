...
describe("Bundle size gate", () => {
  it("total raw source size stays under 92KB", () => {
    ...
    // The dependency-free host-context, participant bridge, secure direct-launch,
    // and explainable-delivery code preserve privacy boundaries without schema libraries.
    // `yarn bundle:size` is the authoritative 15 KB compressed release gate.
    expect(totalKB).toBeLessThan(92);
  });
